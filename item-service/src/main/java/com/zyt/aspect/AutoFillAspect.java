package com.zyt.aspect;

import com.zyt.annocation.AutoFill;
import com.zyt.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.zyt.mapper.*.*(..))&&@annotation(com.zyt.annocation.AutoFill)")
    ...
    public void autoFill(@NonNull JoinPoint joinPoint) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
